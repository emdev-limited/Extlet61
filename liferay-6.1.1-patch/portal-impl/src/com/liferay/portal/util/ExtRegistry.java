...
public class ExtRegistry {
	...
	public static Map<String, Set<String>> getConflicts(
		...
		Set<String> files = _readExtFiles(servletContext, "/WEB-INF/ext-"
				+ servletContextName + ".xml");

		Iterator<Map.Entry<String, Set<String>>> itr = _extMap.entrySet()
				.iterator();
		...
		while (itr.hasNext()) {
			...
			for (String file : files) {
				...
				Set<String> conflictFiles = conflicts
						.get(curServletContextName);
	...
	public static void registerPortal(ServletContext servletContext)
		...
		for (String resourcePath : resourcePaths) {
			if (resourcePath.startsWith("/WEB-INF/ext-")
				...
				String servletContextName = resourcePath.substring(13,
	...
	private static Set<String> _readExtFiles(ServletContext servletContext,
			String resourcePath) throws Exception {

		Set<String> files = new TreeSet<String>();

		Document document = SAXReaderUtil.read(servletContext
